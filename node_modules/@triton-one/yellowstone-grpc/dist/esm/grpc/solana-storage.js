    ...
    fromJSON(object) {
        return {
            ...
            transactions: Array.isArray(object?.transactions)
                ...
                : [],
            rewards: Array.isArray(object?.rewards) ? object.rewards.map((e) => Reward.fromJSON(e)) : [],
...
export const Message = {
    ...
    fromJSON(object) {
        return {
            ...
            accountKeys: Array.isArray(object?.accountKeys) ? object.accountKeys.map((e) => bytesFromBase64(e)) : [],
    ...
    toJSON(message) {
        ...
        if (message.addressTableLookups) {
            obj.addressTableLookups = message.addressTableLookups.map((e) => e ? MessageAddressTableLookup.toJSON(e) : undefined);
        }
        else {
...
export const TransactionStatusMeta = {
    ...
    fromJSON(object) {
        return {
            ...
            preBalances: Array.isArray(object?.preBalances) ? object.preBalances.map((e) => String(e)) : [],
            postBalances: Array.isArray(object?.postBalances) ? object.postBalances.map((e) => String(e)) : [],
            ...
            logMessages: Array.isArray(object?.logMessages) ? object.logMessages.map((e) => String(e)) : [],
